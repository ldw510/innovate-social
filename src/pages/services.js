    ...
    return (
      <Layout>
        ...
        <div className=" hero bg-background py-28">
                <h1 className=" text-main-green font-bold text-2xl md:text-4xl text-center">SERVICES</h1>
        ...
        <section className="bg-main-green bg-opacity-70">
          ...
          <script type="text/javascript" src="../../public/static/script.js"></script>
            <div className="w-5/6 mx-auto py-20 hidden md:block">
             <ul className="stack-cards js-stack-cards  ">
               <li className="stack-cards__item bg-white rounded-xl inner-glow shadow-lg js-stack-cards__item ">
                 <div className="p-2 md:p-4 md:px-2  bg-off-white">
                  <h3 className="text-center font-bold text-xl md:text-2xl text-main-green  py-4 md:py-10">Leadership & Governance</h3>
                  <p className="py-4 text-center  font-semibold text-gray-700 text-md md:text-lg">Stepping into social entrepreneurship often means addressing issues that are close to your heart or community.<br /> It is a brave move, and we are here to back you up every step of the way.</p>
                  <ul className="list-disc list-inside text-gray-700 py-4 pl-6 md:py-10 md:pl-20 ">
               ...
               <li className="stack-cards__item bg-white rounded-lg shadow-lg js-stack-cards__item">
                 <div className="p-2 md:p-4 md:px-2  bg-off-white">
                 <h3 className="text-center font-bold text-xl md:text-2xl text-main-green py-10">Technology & Digital Services</h3>
                  <p className="py-4 text-center font-semibold text-gray-700 text-md md:text-lg"> Choosing the right digital tools can be a game-changer for your enterprise, enhancing your reach, impact, and success.<br /> But the options can be overwhelming. We are here to help you make sense of it all.</p>
                  <ul className="list-disc list-inside text-gray-700 py-10 pl-20">
                   <li>Spending hours on manual processes? </li>
                   <li>Juggling too many websites or costly apps? </li>
                   <li>Worried about implementing a new system? Focus on your core business,<br /> and leave the tech to us. </li>
                  </ul>
               ...
               <li className="stack-cards__item bg-white rounded-lg shadow-lg js-stack-cards__item">
                 <div className="p-2 md:p-4 md:px-2  bg-off-white">
                    <h3 className="text-center font-bold text-xl md:text-2xl text-main-green py-10">Business Planning & Operations</h3>
                    <p className="py-4  text-center font-semibold text-gray-700 text-md md:text-lg">Turning an idea into a sustainable business requires careful planning. Whether you are just starting out or ready for a new chapter, we are here to help you understand your ideas, potential customers, and your impact.</p>
                    <ul className="list-disc list-inside text-gray-700 py-10 pl-20">
               ...
               <li className="stack-cards__item bg-off-white rounded-lg shadow-lg js-stack-cards__item">
                 <div className="p-2  md:p-4 md:px-2 bg-off-white">
                    <h3 className="text-center font-bold text-xl md:text-2xl text-main-green py-10">Revenue & Income Generation</h3>
                    <p className="py-4 text-center font-semibold text-gray-700 text-md md:text-lg">For your enterprise to thrive, it needs a reliable income. Whether that means improving sales, offering new products or services, or generating income from supporters, we are here to help you flourish.</p>
                    <ul className="list-disc list-inside text-gray-700 py-10 pl-20">
               ...
               <li className="stack-cards__item bg-off-white rounded-lg shadow-lg js-stack-cards__item">
                 <div className="p-2 md:p-4 md:px-2 bg-off-white">
                    <h3 className="text-center font-bold text-xl md:text-2xl text-main-green py-10">Tender & Grant Management</h3>
                    <p className="py-4 text-center font-semibold text-gray-700 text-md md:text-lg">Grants and public tenders can be a lifeline for social enterprises. We have the expertise to help you succeed <br /> in securing funding and meeting funder expectations throughout your project.</p>
                    <ul className="list-disc list-inside text-gray-700 py-10 pl-20">
               ...
               <li className="stack-cards__item bg-off-white rounded-lg shadow-lg js-stack-cards__item">
                 <div className="p-2  md:p-4 md:px-2 bg-off-white">
                    <h3 className="text-center font-bold text-xl md:text-2xl text-main-green py-10">Data Governance and Protection</h3>
                    <p className="py-4  text-center font-semibold text-gray-700 text-md md:text-lg">GDPR and data protection can seem complicated, but they do not have to be. We are here to help you understand <br /> and implement simple processes to protect both you and the data you hold.</p>
                    <ul className="list-disc list-inside text-gray-700 py-10 pl-20">
          ...
          <div className="w-5/6 mx-auto grid gap-4 grid-rows-6  py-4 block md:hidden">
